...
//
//
//flip_image(ImageValInt the_image, Imaout_image,
//           type,
//           rows, cols)
//   int   type;
//   long  cols, rows;
...
//
//
//rot90(ImageValInt& the_image, ImageValInt Imaout_image,int rows, int cols){
//
//{
//   int    cd2, i, j, rd2;
//
...
//         for(j=0; j<cols; j++){
//            //out_image[j][cols-1-i] = the_image[i][j];
//         out_image[ind(j,cols-1-i)] = the_image[inr(i,j)];
//      }  /* ends loop over i */
//   }  /* ends if type == 1 or 2 or 3 */
//
//}
